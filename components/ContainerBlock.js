...
export default function ContainerBlock({ children, ...customMeta }) {
  ...
  const meta = {
    title: "Adam Peleback - Developer, Writer, and Esports grassroot organizer",
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://adampeleback.com${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://adampeleback.com${router.asPath}`}
        />
